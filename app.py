...
if selected_page == "Home":
    ...
    <div class="glass-card">
        ...
        <div style="background: rgba(0,0,0,0.3); padding: 15px; border-radius: 8px; margin: 15px 0; border: 1px solid rgba(255,255,255,0.05);">
            <code style="color: #06B6D4; font-family: monospace; font-size: 1.1rem;">git clone https://github.com/Mahmoudsherif00/Crytography-algothrisms-.git</code>
        </div>
        <a href="https://github.com/Mahmoudsherif00/Crytography-algothrisms-" target="_blank" style="text-decoration: none;">
